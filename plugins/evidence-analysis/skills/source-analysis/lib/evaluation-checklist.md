...
Systematic approach to assessing and weighing genealogical evidence.

## Pre-Analysis Checklist

Before evaluating evidence, ensure you have:

- [ ] Clearly defined research question
- [ ] Gathered all reasonably available sources
- [ ] Documented source citations completely
- [ ] Identified sources you couldn't locate
...
|--------|-------------|----------------|-------------|
| Type | Original | Good derivative | Poor derivative |
| Date | Contemporaneous | Within years | Decades later |
| Provenance | Documented | Partial | Unknown |
| Condition | Complete | Mostly intact | Significant gaps |
...
- [ ] Financial benefit (exercise caution)
- [ ] Unknown
...
- [ ] Searched all reasonably available record types
- [ ] Checked multiple repositories
- [ ] Searched variant name spellings
...
|-------|----------|----------|----------|----------|
| Birth year | 1850 | ca. 1850 | 1851 | 1850 |
| Birthplace | Ohio | Muskingum Co. | Ohio | Zanesville |
| Father | John | J. Smith | [blank] | John Smith |
...
4. Is resolution possible?

## Reaching a Conclusion

### Requirements for Sound Conclusion

- [ ] Based on reasonably exhaustive research
- [ ] Each fact has complete citation
...
1. Would a skeptical colleague find my evidence convincing?
2. Have I addressed the most likely objections?
3. Are my citations complete enough for verification?
4. Have I clearly distinguished fact from inference?
5. Am I comfortable being proven wrong by new evidence?
